...
class IconController extends BaseController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        ...
        return $this->render('parametre/icon/index.html.twig', [
            'datatable' => $table,
    ...
    public function new(Request $request, IconRepository $iconRepository, FormError $formError): Response
    {
        ...
        $form = $this->createForm(IconType::class, $icon, [
            'method' => 'POST',
            'action' => $this->generateUrl('app_parametre_icon_new')
        ]);
        ...
        if ($form->isSubmitted()) {
            $response = [];
            $redirect = $this->generateUrl('app_parametre_icon_index');
    ...
    public function edit(Request $request, Icon $icon, IconRepository $iconRepository, FormError $formError): Response
    {
        ...
        return $this->renderForm('parametre/icon/edit.html.twig', [
            'icon' => $icon,
            'form' => $form,
        ]);
    }
    ...
    public function delete(Request $request, Icon $icon, IconRepository $iconRepository): Response
    {
        ...
        return $this->renderForm('parametre/icon/delete.html.twig', [
            'icon' => $icon,
            'form' => $form,
        ]);
    }
