...
class UtilisateurSimpleController extends BaseController
{
    ...
    , 'render' => function ($value, UtilisateurSimple $context) use ($renders) {
    $options = [
    ...
    'actions' => [
    'edit' => [
    'url' => $this->generateUrl('app_utilisateur_utilisateur_simple_edit', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-pen'
    ...
    'show' => [
    'url' => $this->generateUrl('app_utilisateur_utilisateur_simple_show', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-eye'
    ...
    'url' => $this->generateUrl('app_utilisateur_utilisateur_simple_delete', ['id' => $value])
    , 'ajax' => true
